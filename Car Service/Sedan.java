...
// GF01 Gear Fixing ₹ 3000 ₹ 6000 ₹ 8000
    ...
    // price menu
    public Sedan() {
        priceOfServices.put("BS01", 4000);// basic servicing
        priceOfServices.put("EF01", 8000);//engine fixing
        priceOfServices.put("CF01", 4000);//clutch fixing
        priceOfServices.put("BF01", 1500);//brake fixing
        priceOfServices.put("GF01", 6000);//gear fixing
    }

    // display menu
    public void displayMenu() {
        System.out.println("***************** THE MENU CARD FOR SEDAN CAR****************************");
