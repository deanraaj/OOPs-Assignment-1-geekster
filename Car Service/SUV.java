...
// GF01 Gear Fixing ₹ 3000 ₹ 6000 ₹ 8000
    ...
    // price menu
    public SUV() {
        priceOfServices.put("BS01", 5000);// basic servicing
        priceOfServices.put("EF01", 10000);//engine fixing
        priceOfServices.put("CF01", 6000);//clutch fixing
        priceOfServices.put("BF01", 2500);//brake fixing
        priceOfServices.put("GF01", 8000);//gear fixing
    }

    // display menu
    public void displayMenu() {
        System.out.println("***************** THE MENU CARD FOR SUV CAR ****************************");
